export default {
    ...
    home: {
        compositionInfo: "Submissions of each children's choir will be incorporated regularly. This way our video will always be updated.<br />The composition of the image selection is randomly generated. In this way, a different video is created every time you click on it.",
